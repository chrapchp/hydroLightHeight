...
motorDirectionType B1R1_1A_ZY_005 = DOWN; // UP/DOWN DIRECTION
motorStateType B1R1_1A_XY_026 = OFF; // ON/OFF HEIGHT ADJUST
lightingPositionType B1R1_1A_ZY_005_POS; // UP or DOWN when limits are reached.

// bool B1R1_1A_QR_026 = faB1R1_1A_ZY_005lse; // HOME RESET
...
#define LINEAR_ACTUATOR_MAX_LENGTH_PULSE_COUNT  220000//  224000L // maxium 0 - full span

unsigned long B1R1_1A_ZT_001_PULSE_Max = LINEAR_ACTUATOR_MAX_LENGTH_PULSE_COUNT;
volatile long B1R1_1A_ZT_001_PULSE_Count = 0;
...
void on_B1R1_1A_ZT_001_Rising()
{
  ...
  else
  {
    ...
    if(--B1R1_1A_ZT_001_PULSE_Count < 0 )
...
void setup()
{
  ...
  * tracePort << "start direction:" << (B1R1_1A_ZY_005 == UP) << endl;
#endif
...
float getPosition()
{
  return(B1R1_1A_ZT_001_PULSE_Count);
};
...
{
  if (getModbusCoilValue(COIL_STATUS_READ_WRITE_OFFSET, B1R1_1A_ZY_005_MB))
  {
    B1R1_1A_ZY_005 = UP;
  }
  else
